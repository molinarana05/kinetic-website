        ...
        <main className="min-h-screen bg-[#0a0118] text-white">
            ...
            <div className="pt-32 pb-24 px-6 max-w-3xl mx-auto">
                ...
                <div className="prose prose-invert prose-lg max-w-none space-y-10 text-gray-300">
                    ...
                    <section>
                        <h2 className="text-xl font-black text-white uppercase tracking-tight mb-4 border-b border-white/10 pb-2">1. Who We Are</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-black text-white uppercase tracking-tight mb-4 border-b border-white/10 pb-2">2. Information We Collect</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-black text-white uppercase tracking-tight mb-4 border-b border-white/10 pb-2">3. How We Use Your Information</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-black text-white uppercase tracking-tight mb-4 border-b border-white/10 pb-2">4. Legal Basis for Processing (GDPR)</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-black text-white uppercase tracking-tight mb-4 border-b border-white/10 pb-2">5. Data Storage & Processors</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-black text-white uppercase tracking-tight mb-4 border-b border-white/10 pb-2">6. Data Retention</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-black text-white uppercase tracking-tight mb-4 border-b border-white/10 pb-2">7. Your Rights</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-black text-white uppercase tracking-tight mb-4 border-b border-white/10 pb-2">8. Cookies</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-black text-white uppercase tracking-tight mb-4 border-b border-white/10 pb-2">9. Updates to This Policy</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-black text-white uppercase tracking-tight mb-4 border-b border-white/10 pb-2">10. Contact</h2>
