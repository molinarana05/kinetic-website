        ...
        <main className="min-h-screen bg-[#0a0118] text-white">
            ...
            <div className="pt-32 pb-24 px-6 max-w-3xl mx-auto">
                ...
                <div className="prose prose-invert prose-lg max-w-none space-y-10 text-gray-300">
                    ...
                    <section>
                        <h2 className="text-xl font-black text-white uppercase tracking-tight mb-4 border-b border-white/10 pb-2">1. Acceptance of Terms</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-black text-white uppercase tracking-tight mb-4 border-b border-white/10 pb-2">2. About Moxie Digital</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-black text-white uppercase tracking-tight mb-4 border-b border-white/10 pb-2">3. Use of the Site and Free Tools</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-black text-white uppercase tracking-tight mb-4 border-b border-white/10 pb-2">4. Intellectual Property</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-black text-white uppercase tracking-tight mb-4 border-b border-white/10 pb-2">5. Disclaimer of Warranties</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-black text-white uppercase tracking-tight mb-4 border-b border-white/10 pb-2">6. Limitation of Liability</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-black text-white uppercase tracking-tight mb-4 border-b border-white/10 pb-2">7. Third-Party Links</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-black text-white uppercase tracking-tight mb-4 border-b border-white/10 pb-2">8. CRM and Follow-Up Communications</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-black text-white uppercase tracking-tight mb-4 border-b border-white/10 pb-2">9. Governing Law</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-black text-white uppercase tracking-tight mb-4 border-b border-white/10 pb-2">10. Changes to These Terms</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-black text-white uppercase tracking-tight mb-4 border-b border-white/10 pb-2">11. Contact</h2>
